...
import {
  ...
  Images, QrCode, Frame, MapPin, Instagram, Bot, Contact, BadgeCheck, Wand2, Bell, SlidersHorizontal, Megaphone, Inbox, Monitor, Building2,
} from "lucide-react";
...
const items = [
  ...
  { to: "/admin/salon-hesaplari", label: "Salon Hesapları (B2B)", icon: Building2 },
